...
/*********************************************************************************
*********************************************************************************/
void MF522_init(void);//init rc522
...
#define 	MF522_RST_SET       HAL_GPIO_WritePin(MF522_PORT_RST, MF522_PIN_RST, GPIO_PIN_SET); //GPIO_SetBits(GPIOA,GPIO_PIN_3)
...
#define 	MF522_CS_ENABLE     HAL_GPIO_WritePin(MF522_PORT_CS,MF522_PIN_CS, GPIO_PIN_RESET); //SDA is CS pin
...
#define 	__RST_SET           HAL_GPIO_WritePin(PORT_RST, PIN_RST, GPIO_PIN_SET); 
#define 	__RST_RESET         HAL_GPIO_WritePin(PORT_RST, PIN_RST, GPIO_PIN_RESET);

#define 	PORT_CS             GPIOE
#define 	PIN_CS              GPIO_PIN_2
#define 	__CS_ENABLE         HAL_GPIO_WritePin(PORT_CS,PIN_CS, GPIO_PIN_RESET); 
#define 	__CS_DISABLE        HAL_GPIO_WritePin(PORT_CS,PIN_CS, GPIO_PIN_SET);
